...
<?php }else{ ?>
	...
	if( $blog_sidebar_position == 'right' && isset( $blog_sidebar ) ) {
		...
		$content_before .= '<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">';

		$content_after .= '</div>'; // col
		$sidebar_before .= '<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">';
		// .sidebar-area
	...
	if( $blog_sidebar_position == 'left' && isset( $blog_sidebar ) ) {
		$content_before .= '<div class="row">';
		$content_before .= '<div class="col-lg-9 col-lg-push-3 col-md-9 col-md-push-3 col-sm-9 col-xs-9">';

		$content_after .= '</div>'; // col
		$sidebar_before .= '<div class="col-lg-3 col-lg-pull-9 col-md-3 col-md-pull-9 col-sm-3 col-xs-3">';
		// .sidebar-area
		$sidebar_after .= '</div>'; // col
		$sidebar_after .= '</div>'; // row
	}
