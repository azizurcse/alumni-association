...
the Ultimate-Member profile page to have an extra tab and that tab can show the UPG post of your choice.<br><br>Settings saved at above [UPG-Post Gallery] tab will be implemented.', 'wp-upg' );
 ...
 function upg_primary_free_settings()
 {
	...
	<b>Display Post Youtube URL Button:</b> <input type="checkbox" name='upg_settings[primary_show_youtube_button]' value='1' <?php if($options['primary_show_youtube_button']=='1') echo 'checked="checked"'; ?> ><br>
...
$options = get_option('upg_settings');
	...
	echo "<b>Select POST IMAGE page. <a href='".admin_url( 'edit.php?post_type=page' )."'>page</a>.</b>: ";
    wp_dropdown_pages(
        array(
	...
	echo "<b>Select POST YOUTUBE VIDEO URL page. <a href='".admin_url( 'edit.php?post_type=page' )."'>page</a>.</b>: ";
    wp_dropdown_pages(
        array(
...
<br>
	...
	<hr>
	<b>To display single UPG post by ID</b><br>
