...
jQuery(document).ready(function($){
	...
	<ul>
		...
		<li><a href="#tab-4"><?php echo '<img src="'.upg_PLUGIN_URL.'/images/new.png"> '; ?>  <?php echo __("Post Form File","wp-upg");?></a></li>
		<li><a href="#tab-5"><?php echo '<img src="'.upg_PLUGIN_URL.'/images/new.png"> '; ?>  <?php echo __("Post YouTube File","wp-upg");?></a></li>
       </ul>
	 <div id="tab-1">
	...
	* Even after plugin update, your changes will not be lost.
	...
	<a href="<?php echo plugins_url( '/wp-upg/layout/form/personal/personal_post_form.txt'); ?>" target="_blank">Get sample code</a>
	</td>
	<td valign='top' style="background-color:#eeeeee ;">
	...
	* Even after plugin update, your changes will not be lost.
	...
	<br>
	<a href="<?php echo plugins_url( '/wp-upg/layout/form/personal/personal_post_youtube.txt'); ?>" target="_blank">Get sample code</a>
	</td>
	<td valign='top' style="background-color:#eeeeee ;">
