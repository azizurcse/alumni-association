...
$pattern = 
                ...
                | dailymotion\.com 	# dailymotion.com
                  ...
                  | /video/ # vimeo extention
                  )             # End path alternatives.
                )               # End host alternatives.
                ([\w-]{7,12})  # Allow 7-12 for 11 char youtube id.
                $%x'
                ;
...
function upg_getimg_youtube($url)
{
	...
	elseif(strlen($youtube_id) ==9){
		return 'https:\/\/i.vimeocdn.com\/video\/'.$youtube_id.'_295x166.webp';
	}
	else{
		return 'https://www.dailymotion.com/thumbnail/video/'.$youtube_id;
	}
	// return 'http://img.youtube.com/vi/'.$youtube_id.'/mqdefault.jpg';
}
...
function upg_video_preview_url($url)
{
	...
	elseif(strlen($youtube_id) ==9){
		return 'https://vimeo.com/video/'.$youtube_id;
	}
	else{
		return 'https://www.dailymotion.com/embed/video/'.$youtube_id.'?rel=0&amp;wmode=transparent';
	}
